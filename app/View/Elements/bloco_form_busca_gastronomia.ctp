<div class="bloco-form" style="margin-top:110px; margin-left:-5px; width:288px;">
	<div class="row">
		<form class="form" action="#?" type="GET" id="form-filtro">
			...
			<label>
				<button class="button button-radius f-right mt10" style="width: 90px; height: 34px;   background:url('img/btn_buscar.png') no-repeat; margin-top:-0px;" id="btSubmit"></button>
			</label>
		</form>
	</div>
</div>
